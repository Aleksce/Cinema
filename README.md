...
- Добавлен полноценный стартовый экран авторизации (overlay) в стиле приложения.
- Добавлено анимированное раскрытие карточки фильма (модальное окно «Подробнее»).
- Добавлены hover-анимации для кнопок и карточек фильмов.
- Добавлен принудительный sync с TMDB по кнопке «Синхр. TMDB».
